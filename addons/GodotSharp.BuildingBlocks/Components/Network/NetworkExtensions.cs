...
namespace GodotSharp.BuildingBlocks
{
    ...
    {
        public static bool IsSinglePlayerMode(this Node node)
            => node.Multiplayer.MultiplayerPeer is OfflineMultiplayerPeer or null;

        public static bool IsMultiplayerServer(this Node node)
            => !node.IsSinglePlayerMode() && node.Multiplayer.IsServer();
